...
static struct argp_option options[] = {
  {"host",       'h', "HOST",       0,                   "PowerDB server IP address to connect. The default host is localhost."},
  ...
  {"user",       'u', "USER",       0,                   "The PowerDB user name to use when connecting to the server."},
