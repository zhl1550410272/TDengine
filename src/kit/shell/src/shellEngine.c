...
#else
  #ifdef CLUSTER
    char    CLIENT_VERSION[] = "Welcome to the PowerDB shell from linux, enterprise client version:%s ";
  #else
    char    CLIENT_VERSION[] = "Welcome to the PowerDB shell from linux, community client version:%s ";
  #endif
#endif
