...
int checkVersion() {
  if (sizeof(int8_t) != 1) {
    printf("power int8 size is %d(!= 1)", (int)sizeof(int8_t));
    return 0;
  }
  if (sizeof(int16_t) != 2) {
    printf("power int16 size is %d(!= 2)", (int)sizeof(int16_t));
    return 0;
  }
  if (sizeof(int32_t) != 4) {
    printf("power int32 size is %d(!= 4)", (int)sizeof(int32_t));
    return 0;
  }
  if (sizeof(int64_t) != 8) {
    printf("power int64 size is %d(!= 8)", (int)sizeof(int64_t));
    return 0;
  }
  return 1;
}
